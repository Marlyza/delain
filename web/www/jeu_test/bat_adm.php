...
if ($erreur == 0)
{
    ...
    switch ($methode)
    {
        ...
        case "debut":
            ...
            $req = $req . "(select count(parene_perso_cod) from perso_arene join perso on perso_cod=parene_perso_cod and perso_actif='O' and perso_type_perso=1 ";
            ...
            $req = $req . "and parene_perso_cod = perso_cod and perso_actif='O' and perso_type_perso=1) as jnv, ";
